...
public class ConsumerResultadoLogin {
    public ConsumerResultadoLogin() {
    }

    public boolean coonsumerResultadoLogin() {
        ...
        try (Consumer<String, String> kafkaConsumer = new KafkaConsumer<>(consumerProperties)) {
            ...
            String topicName = "topicoResultadoLogin";
