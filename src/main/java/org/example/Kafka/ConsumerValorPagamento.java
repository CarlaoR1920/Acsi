...
public class ConsumerValorPagamento {
    public ConsumerValorPagamento() {
    }

    public float consumerValorPagamento() {
        ...
        try (Consumer<String, String> kafkaConsumer = new KafkaConsumer<>(consumerProperties)) {
            ...
            String topicName = "topicoResultPrecoRota";
